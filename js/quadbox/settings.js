 ...
 * defaults, deepMerge and load/save are verbatim; the svelte writable is
 * replaced by a plain object + subscriber list. Storage key and JSON
 * shape are unchanged (NEVER rename: quad-box-settings).
 */
