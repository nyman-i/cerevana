...
Sort a mixed sequence of letters and numbers mentally: numbers ascending, then letters alphabetically.
...
Mental word-problem arithmetic solved under a time limit.
...
A broad, well-known general-aptitude test.

https://www.seemypersonality.com/IQ-Test

# Old SAT (Pre-1994)

Category: General aptitude
Access: Free (community-built simulator)
Time: ~3 hours (full form)

Considered one of the most g-loaded tests ever given at scale, from before extensive coaching/test-prep could inflate scores independent of underlying ability. This is a community digitization of a 1980 form.
